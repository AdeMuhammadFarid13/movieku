...
public class ReviewBig4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_big4);

        ratingBar = findViewById(R.id.ratebig4);
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(ReviewBig4.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        dbHandler = new DBHandler(ReviewBig4.this);
        ...
        addCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courseName.isEmpty() && courseTracks.isEmpty() &&
                    ...
                    Toast.makeText(ReviewBig4.this, "Data Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(ReviewBig4.this, "Review Telah Ditambahkan", Toast.LENGTH_SHORT).show();
        ...
        readCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ReviewBig4.this, ViewCourses.class);
                startActivity(i);
            }
        });
    }
