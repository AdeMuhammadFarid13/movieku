...
public class ReviewMario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_mario);

        ratingBar = findViewById(R.id.ratemario);
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(ReviewMario.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        dbHandler = new DBHandler(ReviewMario.this);
        ...
        addCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courseName.isEmpty() && courseTracks.isEmpty() &&
                    ...
                    Toast.makeText(ReviewMario.this, "Data Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(ReviewMario.this, "Review Telah Ditambahkan", Toast.LENGTH_SHORT).show();
        ...
        readCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ReviewMario.this, ViewCourses.class);
                startActivity(i);
            }
        });
    }
