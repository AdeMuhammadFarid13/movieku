...
public class ReviewAvatar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingBar = findViewById(R.id.rateavatar);
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(ReviewAvatar.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        dbHandler = new DBHandler(ReviewAvatar.this);
        ...
        addCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courseName.isEmpty() && courseTracks.isEmpty() &&
                    ...
                    Toast.makeText(ReviewAvatar.this, "Data Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(ReviewAvatar.this, "Review Telah Ditambahkan", Toast.LENGTH_SHORT).show();
        ...
        readCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ReviewAvatar.this, ViewCourses.class);
                startActivity(i);
            }
        });
    }
