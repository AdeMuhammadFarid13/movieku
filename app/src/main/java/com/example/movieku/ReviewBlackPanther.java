...
public class ReviewBlackPanther extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingBar = findViewById(R.id.rateblackp);
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(ReviewBlackPanther.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        dbHandler = new DBHandler(ReviewBlackPanther.this);
        ...
        addCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courseName.isEmpty() && courseTracks.isEmpty() &&
                    ...
                    Toast.makeText(ReviewBlackPanther.this, "Data Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(ReviewBlackPanther.this, "Review Telah Ditambahkan", Toast.LENGTH_SHORT).show();
        ...
        readCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ReviewBlackPanther.this, ViewCourses.class);
                startActivity(i);
            }
        });
    }
