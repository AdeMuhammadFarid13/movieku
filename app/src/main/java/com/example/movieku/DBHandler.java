...
public class DBHandler extends SQLiteOpenHelper{
    ...
    // below method is for creating a database by running a sqlitequery
    @Override
    ...
    public ArrayList<CourseModal> readCourses() {
        ...
        // on below line we are creating a cursor with query to readdata from database.
    ...
    public void updateCourse(String originalCourseName, String courseName, String courseDescription, String courseTracks, String courseDuration) {
        ...
        // and we are comparing it with name of our course which isstored in original name variable.
